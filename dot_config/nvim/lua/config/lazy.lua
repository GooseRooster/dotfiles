...
-- minimal baseline plus whatever NVIM_LANGS opts in. This replaces what used to
-- be a static `:LazyExtras`-style list — profile.lua is now the source of truth,
-- so don't run `:LazyExtras` (it would write lazyvim.json outside this gate).
